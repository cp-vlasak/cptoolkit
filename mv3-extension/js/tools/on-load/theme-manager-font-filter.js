(function loadTool() {
  ...
  function ensureStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
#${CONTROL_ID}{display:inline-flex;flex-wrap:wrap;align-items:center;gap:6px 8px;margin:10px 16px;padding:6px 10px;border:1px solid #d5ddeb;border-radius:8px;background:#f7f9fc;font-family:"Segoe UI",Arial,sans-serif;max-width:65%}
